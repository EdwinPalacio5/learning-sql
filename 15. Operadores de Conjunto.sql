...
-- Minus
-- Devuelve todas la filas distintas seleccionadas por la primera consulta, pero no están presentes en el segundo 
-- conjunto
...
-- misma estructura y tipo de datos. Hbará ocasiones en que se quiera coincider dos conjuntos que 
...
-- Aclaración: Los nombres de las columnas serán dados por el primer conjunto
